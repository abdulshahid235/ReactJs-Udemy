    ...
    <>
      ...
      <Main>
        <Box>
          ...
          {/* 1. loading and no error*/}
          {isLoading && !error && <Loader />}
          {/* 2. error */}
          {error && <ErrorMessage message={error} />}
          {/* 3. no loading and no error */}
          {!isLoading && !error && (
...
//is commented because Box component has been reused to create this component
// function WatchedBox() {
  ...
  useEffect(
    function () {
      async function getMovieDetails() {
        ...
        // http://www.omdbapi.com/?i=tt3896198&apikey=fdf43b60&i=tt1375666
        const data = await res.json();
        setMovie(data);
        setIsLoading(false);
